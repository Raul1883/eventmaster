...
Для локального запуска также понадобиться создать сервисный аккаунт в облаке и добавить в корень authorized_key.json, добавить в .env FROM_JSON_AUTH=true
