...
Для локального запуска также понадобиться создать сервисный аккаунт в облаке и добавить в корень authorized_key.json, после чего закомментировать 24 строку и раскомментировать 23 в db-func.js. 
